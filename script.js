...
const menuData = {
  tiffin: [
    ...
    { type: 'item', name: 'Onion Dosa', price: 20, thumb: '/real_dosa.png', emoji: '🫓', desc: 'Crispy dosa with caramelized onions' },
    { type: 'item', name: 'Plain Dosa', price: 15, thumb: '/real_dosa.png', emoji: '🫓', desc: 'Classic crispy dosa with sambar & chutney' },
    { type: 'item', name: 'Egg Dosa', price: 30, thumb: '/real_egg_dosa.png', emoji: '🥚', desc: 'Crispy dosa layered with fluffy egg' },
    { type: 'item', name: 'Double Egg Dosa', price: 40, thumb: '/real_egg_dosa.png', emoji: '🥚', desc: 'Double egg loaded dosa with spicy chutney', badge: '<span class="mi-badge special">🔥 Special</span>', rowClass: 'bestseller-row' },
    { type: 'item', name: 'Upma Pesara Attu', price: 30, emoji: '🥘', desc: 'Moong dal crepe with upma filling' },
    { type: 'item', name: 'Uthapam', price: 30, thumb: '/real_uthapam.png', emoji: '🫓', desc: 'Thick pancake with onions, tomatoes & chillies' },
  ],
  drinks: [
    { type: 'item', name: 'Badam Milk', price: 30, thumb: '/real_badammilk.png', emoji: '🥛', desc: 'Rich & creamy almond milk' },
    { type: 'item', name: 'Lassi', price: 25, thumb: '/real_lassi.png', emoji: '🥛', desc: 'Traditional creamy yogurt drink' },
    { type: 'label', text: '🥤 Thums Up' },
    { type: 'item', name: 'Thums Up 250ml', price: 20, thumb: '/real_thumsup.png', emoji: '🥤', rowClass: 'size-row' },
    { type: 'item', name: 'Thums Up 1L', price: 50, thumb: '/real_thumsup.png', emoji: '🥤', rowClass: 'size-row' },
    { type: 'item', name: 'Thums Up 2.5L', price: 100, thumb: '/real_thumsup.png', emoji: '🥤', rowClass: 'size-row' },
    { type: 'label', text: '🍊 Fanta' },
    { type: 'item', name: 'Fanta 250ml', price: 20, thumb: '/real_fanta.png', emoji: '🍊', rowClass: 'size-row' },
    { type: 'item', name: 'Fanta 1L', price: 50, thumb: '/real_fanta.png', emoji: '🍊', rowClass: 'size-row' },
    { type: 'item', name: 'Fanta 2.5L', price: 100, thumb: '/real_fanta.png', emoji: '🍊', rowClass: 'size-row' },
    { type: 'label', text: '🥤 Pepsi' },
    { type: 'item', name: 'Pepsi 250ml', price: 20, thumb: '/real_pepsi.png', emoji: '🥤', rowClass: 'size-row' },
    { type: 'item', name: 'Pepsi 1L', price: 50, thumb: '/real_pepsi.png', emoji: '🥤', rowClass: 'size-row' },
    { type: 'item', name: 'Pepsi 2.5L', price: 100, thumb: '/real_pepsi.png', emoji: '🥤', rowClass: 'size-row' },
    { type: 'label', text: '💧 Water Bottle' },
    { type: 'item', name: 'Water Bottle 500ml', price: 10, thumb: '/real_water.png', emoji: '💧', rowClass: 'size-row' },
    { type: 'item', name: 'Water Bottle 1L', price: 20, thumb: '/real_water.png', emoji: '💧', rowClass: 'size-row' },
    { type: 'item', name: 'Water Bottle 2L', price: 35, thumb: '/real_water.png', emoji: '💧', rowClass: 'size-row' },
    { type: 'label', text: '🍊 Pulpy Orange' },
    { type: 'item', name: 'Pulpy Orange 200ml', price: 25, thumb: '/real_pulpyorange.png', emoji: '🍊', rowClass: 'size-row' },
    { type: 'item', name: 'Pulpy Orange 1L', price: 50, thumb: '/real_pulpyorange.png', emoji: '🍊', rowClass: 'size-row' },
  ],
  snacks: [
    { type: 'item', name: 'Bajji (1 pc)', price: 5, thumb: '/real_bajji.png', emoji: '🌶️', desc: 'Crispy battered chilli fritter' },
    { type: 'item', name: 'Punukulu (Plate)', price: 20, thumb: '/real_bonda.png', emoji: '🧆', desc: 'Golden fried rice flour dumplings' },
    { type: 'item', name: 'Samosa (1 pc)', price: 10, thumb: '/real_samosa.png', emoji: '🔺', desc: 'Crispy pastry with spiced potato filling' },
    { type: 'item', name: 'Pani Puri', price: 20, thumb: '/real_panipuri.png', emoji: '🫕', desc: 'Crispy puris filled with tangy flavored water', badge: '<span class="mi-badge">★ Popular</span>', rowClass: 'bestseller-row' },
    { type: 'item', name: 'Chat', price: 20, thumb: '/real_panipuri.png', emoji: '🥗', desc: 'Tangy & spicy mixed chat with chutneys' },
    { type: 'item', name: 'Pakodi', price: 20, thumb: '/real_bajji.png', emoji: '🍘', desc: 'Crispy onion & vegetable fritters' },
    { type: 'item', name: 'Jelebi (1 pc)', price: 5, thumb: '/real_jalebi.png', emoji: '🍩', desc: 'Sweet crispy spiral soaked in sugar syrup' },
  ]
};
